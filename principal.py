...
def main():
    ...
    try:
        ...
        # 🛡️ SENTINEL: Fail Securely
        # Captura exceções não tratadas para evitar vazamento de stack trace.
        # Loga o erro completo para análise e exibe uma mensagem genérica ao usuário.
        logging.critical("🚨 ERRO CRÍTICO INESPERADO NO APOLO ENGINE 🚨", exc_info=True)
        print("\n❌ Ocorreu um erro fatal. A simulação foi encerrada.")
