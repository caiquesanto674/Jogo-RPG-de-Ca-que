...
from apolo_engine.utils import frase_confirmacao


class SistemaAutoCorrecao:
    """Monitora e corrige automaticamente falhas graves de recursos."""

    def __init__(self, limite_comida=1000):
        self.limite_comida = limite_comida

    def monitorar(self, economia):
        return economia.recursos["comida"] < self.limite_comida
